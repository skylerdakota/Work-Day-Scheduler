...
$("#currentDay").text(now);
// if statement to recognize if an activity is in the past, present or future
// -- adding and removing classes to go in past present or future
// -- respond by changing color of block
